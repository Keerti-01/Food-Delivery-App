  ...
  return (
    <>
      <div className="w-full h-60 md:hidden">
        <img
          src={props.images.lenght && props.images[0].location}
      ...
      <div className="hidden w-full h-96 md:flex gap-1">
        ...
        <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
          <img
            src={props.images.lenght >= 1 && props.images[1].location}
            alt="restuarant image"
            className="w-full h-2/4 object-cover rounded-lg  transform transition duration-700 hover:scale-110"
          />
          <img
            src={props.images.lenght >= 2 && props.images[2].location}
            alt="restuarant image"
            className="w-full h-2/4 object-cover rounded-lg  transform transition duration-700 hover:scale-110"
          />
        </div>
        <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
          <div className="w-full h-2/4 relative ">
            <img
              src={props.images.lenght >= 3 && props.images[3].location}
              alt="restuarant image"
          ...
          <div className="w-full h-2/4 relative ">
            <img
              src={props.images.lenght >= 4 && props.images[4].location}
              alt="restuarant image"
              className="w-full h-full object-cover rounded-lg "
            />
